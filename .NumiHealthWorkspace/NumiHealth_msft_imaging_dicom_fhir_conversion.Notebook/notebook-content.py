...
from microsoft.fabric.hls.hds.medical_imaging.dicom.core.metadata_fhir_convertor import MetadataToFhirConvertor
import json

# convert inline params into dictionary
inline_params_dict = json.loads(inline_params)

dicom_fhir_convertor = MetadataToFhirConvertor(spark, 
